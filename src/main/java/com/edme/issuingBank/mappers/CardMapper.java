...
public interface CardMapper {
    ...
    @Mapping(target = "cardStatus", source = "cardStatusId", qualifiedByName = "mapCardStatus")
    @Mapping(target = "paymentSystem", source = "paymentSystemId", qualifiedByName = "mapPaymentSystem")
