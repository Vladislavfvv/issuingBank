...
public class CardDto {
    ...
    @Schema(description = "Timestamp when data was sent to the processing center", example = "2022-10-21 13:12:12.159")
    private Timestamp sentToProcessingCenter;

    @NotNull(message = "Received from processing center timestamp is required")
    @JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "yyyy-MM-dd HH:mm:ss.SSS")
    @Schema(description = "Timestamp when data was received from the processing center", example = "2022-10-21 13:12:12.159")
