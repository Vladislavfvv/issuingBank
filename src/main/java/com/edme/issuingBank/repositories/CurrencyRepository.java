...
public interface CurrencyRepository extends JpaRepository<Currency, Long> {
    ...
    @Modifying
    @Transactional
    @Query(value = "DROP TABLE IF EXISTS issuingbankschema.currency CASCADE", nativeQuery = true)
    void dropTable();

    @Modifying
    @Transactional
    @Query(value = "CREATE TABLE IF NOT EXISTS issuingbankschema.currency(" +
    ...
    @Modifying
    @Transactional
    @Query(value = "INSERT INTO issuingbankschema.currency(currency_digital_code, currency_letter_code, currency_digital_code_account," +
                   "                                       currency_name)" +
